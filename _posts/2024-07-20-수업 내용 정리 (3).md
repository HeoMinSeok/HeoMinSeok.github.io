...
<style>
  ...
  @media (max-width: 768px) {
    ...
    .link-container img, .link-content {
      width: 100%;
      margin: 10px 0;
    }
...
<div class="link-container" onclick="window.open('https://developer.mozilla.org/ko/docs/Glossary/Hoisting', '_blank');">
  <img src="./assets/img/posts/training/mozilla-logo.png" alt="Kakao Developers"/>
  <div class="link-content">
    <h2>JavaScript | MDN</h2>
    <p>JavaScript (JS)는 가벼운, 인터프리터 혹은 just-in-time 컴파일 프로그래밍 언어로, 일급 함수를 지원합니다. JavaScript (JS)는 가벼운, 인터프리터 혹은 just-in-time 컴파일 프로그래밍 언어로, 일급 함수를 지원합니다.JavaScript (JS)는 가벼운, 인터프리터 혹은 just-in-time 컴파일 프로그래밍 언어로, 일급 함수를 지원합니다.JavaScript (JS)는 가벼운, 인터프리터 혹은 just-in-time 컴파일 프로그래밍 언어로, 일급 함수를 지원합니다.JavaScript (JS)는 가벼운, 인터프리터 혹은 just-in-time 컴파일 프로그래밍 언어로, 일급 함수를 지원합니다.</p>
